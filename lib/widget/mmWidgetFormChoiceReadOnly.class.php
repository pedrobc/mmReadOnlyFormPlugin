 ...
 */
class mmWidgetFormChoiceReadOnly extends sfWidgetFormChoice
{
  /**
   * Constructor.
   *
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    return $this->getRenderer()->render($name . '_readonly', $value, array_merge(array('disabled' => 'disabled'), $attributes), $errors) .
